...
namespace Eagle.Core.Linq
{
    public abstract class ExpressionVisitor
    {
        ...
        {
            throw new Exception(string.Format("", "expression", expression.NodeType));
        }
        ...
        protected virtual MemberBinding VisitBinding(MemberBinding binding)
        {
            switch (binding.BindingType)
            {
                ...
                default:
                    throw new Exception(string.Format("", "binding", binding.BindingType));
            }
        }
