...
namespace Eagle.Dapper
{
    public sealed class Database
    {
        ...
        {
            return this.dbConfiguration.DbDriver.DiscoverParams(sql);
        }
        ...
        {
            DbCommand command = this.dbConfiguration.DbProviderFactory.CreateCommand();
        ...
        {
            DbParameter param = this.dbConfiguration.DbProviderFactory.CreateParameter();
            param.ParameterName = this.dbConfiguration.DbDriver.BuildParameterName(name);
            return param;
        }
        ...
        {
            get { return this.dbConfiguration.ConnectionString; }
        }
        ...
        {
            return this.dbConfiguration.DbProviderFactory.CreateDataAdapter();
        }

        public ISqlStatementFactory GetSqlStatementFactory()
        {
            return this.dbConfiguration.DbDriver.CreateStatementFactory();
        }
        ...
        {
            return this.CreateConnection(tryOpenning);
        }

        public DbConnection CreateConnection()
        {
            DbConnection newConnection = this.dbConfiguration.DbProviderFactory.CreateConnection();
        ...
        object value)
        {
            ...
            this.dbConfiguration.DbDriver.AdjustParameter(parameter);
